...
/**
 * Quill's Material 3 theme.
 *
 * On Android 12+ (API 31) it can extract wallpaper-based dynamic color; on Android 10/11
 * (our Sony Xperia SO-51A test device) it always falls back to the hand-crafted static palette.
 */
@Composable
fun QuillTheme(
